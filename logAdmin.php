...
<head>
    ...
    * {
    ...
    .center:hover {
        ...
        transition: 0.5s;
        box-shadow: 0 4px 30px rgba(75, 230, 44, 0.651);
...
<body>
    ...
    <div class="center">
        <h1>Login</h1>
        <form name="f2" action="logAdmin.php" method="POST">
            <div class="txt_field">
            ...
            <div class="home_link">
                <a id="lnk" href="index.html">Return Home</a>
            </div>
        </form>
    </div>
    </form>
...
if(isset($_POST['submit']))
{
    ...
    $sql = "select *from admin where T_ID = '$username' and Pass = '$password'";

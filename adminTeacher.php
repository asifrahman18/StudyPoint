    ...
    <header>
        <div class="overlay">
            ...
            <div class="boxx">
                ...
                <form name="f2" action="adminTeacher.php" method="POST">
            ...
            <?php
                if(isset($_POST['bking'])){
                    ...
                    $sql3 = "DELETE FROM teaches WHERE T_ID = $user";
                    $result2 = mysqli_query($conn , $sql2);
                    $result3 = mysqli_query($conn , $sql3);
                    
                    echo "<script>window.location.href='adminTeacher.php?deletion_confirm'</script>";
                    }
                    else
                    {
